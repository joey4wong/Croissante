...
struct AppColors {
    ...
    static let nocturneBackgroundTop = Color(red: 0.22, green: 0.18, blue: 0.16)
    static let nocturneBackgroundMid = Color(red: 0.13, green: 0.11, blue: 0.10)
    static let nocturneBackgroundBottom = Color(red: 0.07, green: 0.06, blue: 0.06)

    static let nocturneSurface = Color(red: 0.18, green: 0.14, blue: 0.13)
    static let nocturneSurfaceElevated = Color(red: 0.22, green: 0.17, blue: 0.15)
    ...
    static let nocturneWarmGlow = Color(red: 0.92, green: 0.56, blue: 0.35)
...
extension AppColors {
    static func usesPorcelainStyle(themeMode: ThemeMode, isDarkMode: Bool) -> Bool {
        themeMode == .porcelain || (themeMode == .system && !isDarkMode)
    }
    ...
    static func elevatedSurfaceGlowStyle(themeMode: ThemeMode = .system, isDarkMode: Bool, elevated: Bool = false) -> AnyShapeStyle {
        ...
        return AnyShapeStyle(
            LinearGradient(
                colors: [
                    nocturneWarmGlow.opacity(elevated ? 0.22 : 0.16),
                    Color(red: 0.93, green: 0.86, blue: 0.80).opacity(elevated ? 0.10 : 0.07),
                    Color.clear
                ],
        ...
        ZStack {
            ...
            if AppColors.usesDarkGlassStyle(themeMode: themeMode, isDarkMode: isDarkMode) {
                GeometryReader { proxy in
                    ZStack {
                        ambientGlow(
                            color: AppColors.nocturneWarmGlow.opacity(0.32),
                        ...
                        ambientGlow(
                            color: Color(red: 0.99, green: 0.91, blue: 0.83).opacity(0.24),
                        ...
                        ambientGlow(
                            color: Color(red: 0.55, green: 0.31, blue: 0.22).opacity(0.16),
